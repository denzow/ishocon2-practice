...
async def post_vote(request):
    ...
    await set_vote_count_cache_by_candidate_id(candidate_id, vote_count)
    await set_vote_keyword_count_cache_by_candidate_id(candidate_id, form_base['keyword'],  vote_count)
    await set_voted_count_cache_by_user_id(user_id, vote_count)
